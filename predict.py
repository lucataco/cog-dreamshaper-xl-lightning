...
MODEL_URL = "https://weights.replicate.delivery/default/lykon/dreamshaper-xl-lightning.tar"
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        guidance_scale: float = Input(
            description="Scale for classifier-free guidance", ge=0, le=50, default=2
        ),
